...
if mode == "Double Slit":
    ...
    c1.metric("Envelope (m=1)", f"{env_dist:.2f} mm")
    c2.metric("Int. Min. (m=1)", f"{int_min1:.2f} mm")
    c3.metric("Int. Max. (m=1)", f"{int_max1:.2f} mm")
    c4.metric("Int. Max. (m=2)", f"{int_max2:.2f} mm")
